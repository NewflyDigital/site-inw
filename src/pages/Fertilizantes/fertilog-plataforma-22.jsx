    ...
    <>
      ...
      <section className={styles.backgroundimg}>
        <div className={styles.box}>
          ...
          <h2>FERTILOG PLATAFORMA / CHASSI 22.5 TON</h2>
        </div>
      </section>
        ...
        <div className={styles.interno}>
          ...
          <div className={styles.box}>
            <img
              ...
              src="/static/images/produtos/LinhaDeFertilizantes/Fertilog-PlataformaOuChassi-22.5ton-01.jpg"
            />
          </div>
        </div>
      </section>
        ...
        <div className={styles.interno}>
          <div className={styles.box}>
            <img
              ...
              src="/static/images/produtos/LinhaDeFertilizantes/Fertilog-PlataformaOuChassi-22.5ton-02.jpg"
            />
          </div>
      ...
      <section className={styles.background}>
        ...
        <div className={styles.interno4}>
          <div className={styles.box3}>
            ...
            <p className={styles.paragrafo}>
              {activeTab === "descricao"
                ? "O Fertilog 22.5 permite abastecimento eficiente e contínuo de fertilizantes durante as operações agrícolas."
                : "Aumenta a autonomia operacional e reduz deslocamentos durante o abastecimento."}
            </p>
          </div>
          ...
          <div className={styles.box2}>
            <img
              ...
              src={
                activeTab === "descricao"
                  ? "/static/images/produtos/LinhaDeFertilizantes/Fertilog-PlataformaOuChassi-22.5ton-03.jpg"
                  : "/static/images/produtos/LinhaDeFertilizantes/Fertilog-PlataformaOuChassi-22.5ton.jpg"
              }
            />
          </div>
        </div>
      ...
      <div className={styles.whats}>
        <Link
          legacyBehavior
          href="https://api.whatsapp.com/send?phone=5554991391183&text=Ol%C3%A1%2C%20vim%20pelo%20site%20e%20tenho%20interesse%20no%20produto%20Fertilog%20Plataforma%20ou%20Chassi%2022.5%20ton"
        >
          <a target="_blank">
