      ...
      <section className={styles.background}>
        <div className={styles.interno2}>
          <img
            ...
            src="/static/images/produtos/LinhaDeFertilizantes/Fertilog-Express-1000.jpg"
          />
        </div>
      </section>
        ...
        <div className={styles.interno}>
          <div className={styles.box3}>
            ...
            <p className={styles.paragrafo}>
              O Fertilog Express 1000 é uma solução de transporte por esteira desenvolvida para movimentação rápida e eficiente de fertilizantes.
            </p>

            <p className={styles.paragrafo}>
           Com vazão de até 1 tonelada por minuto, o equipamento garante fluxo constante e alto desempenho nas operações agrícolas.
            </p>
