    ...
    <>
      ...
      <section className={styles.backgroundimg}>
        <div className={styles.box}>
          ...
          <h2 className="uppercase">Big Tanque Rebocado 3500</h2>
        </div>
      </section>
      ...
      <section className={styles.background}>
        <div className={styles.interno2}>
          <img
            ...
            src="/static/images/produtos/AguaECalda/Bigtanque-Rebocado-3500-00.png"
          />
        </div>
      </section>
        ...
        <div className={styles.interno}>
          ...
          <div className={styles.box}>
            <img
              ...
              src="/static/images/produtos/AguaECalda/Bigtanque-Rebocado-3500-01.jpg"
            />
          </div>
        </div>
      </section>
        ...
        <div className={styles.interno}>
          <div className={styles.box}>
            <img
              ...
              src="/static/images/produtos/AguaECalda/Bigtanque-Rebocado-3500-02.jpg"
            />
          </div>
