...
export default function Implementos() {
  ...
  const produtos = [
    ...
    {
      id: 29,
      nome: "Big Tanque Rebocado 28.500L Calda Pronta 600",
      imagem:
    ...
    {
      id: 30,
      nome: "Big Tanque Roll on Roll Off 8000",
    ...
    {
      id: 31,
      nome: "Big Tanque Roll on Roll Off 9500",
    ...
    {
      id: 32,
      nome: "Big Tanque Roll on Roll Off 10500",
    ...
    {
      id: 33,
      nome: "Big Tanque Roll on Roll Off 10700",
    ...
    {
      id: 34,
      nome: "Big Tanque Roll on Roll Off 10700 Caldeiro 1200",
      imagem:
    ...
    {
      id: 35,
      nome: "Big Tanque Roll on Roll Off 10700 Caldeiro 2000",
      imagem:
    ...
    {
      id: 36,
      nome: "Big Tanque Roll on Roll Off 12000",
    ...
    {
      id: 37,
      nome: "Big Tanque Roll on Roll Off 13000",
    ...
    {
      id: 38,
      nome: "Big Tanque Roll on Roll Off 13500",
    ...
    {
      id: 39,
      nome: "Big Tanque Roll on Roll Off 16050",
    ...
    {
      id: 40,
      nome: "Big Tanque Roll on Roll Off 19000",
